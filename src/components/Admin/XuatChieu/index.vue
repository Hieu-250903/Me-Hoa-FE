                        ...
                        <tbody>
                            <template v-for="(item, index) in list_suat_chieu" :key="index">
                                <tr class="text-nowrap">
                                    ...
                                    <td class="align-middle text-center">{{ item.gio_bat_dau }}</td>
                                    <td class="align-middle text-center">{{ item.gio_ket_thuc }}</td>
                                    <td class="align-middle text-center">{{ item.gia_ve }}</td>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="time" class="form-control" v-model="create_suat_chieu.gio_bat_dau" />
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Giờ Kết Thúc</label>
                            <input type="time" class="form-control" v-model="create_suat_chieu.gio_ket_thuc" />
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Giá Vé</label>
                            <input type="number" class="form-control" v-model="create_suat_chieu.gia_ve" />
                        </div>
                        <div class="col-md-6 mb-3">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Giờ Bắt Đầu</label>
                            <input type="time" class="form-control" v-model="edit_suat_chieu.gio_bat_dau" />
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Giờ Kết Thúc</label>
                            <input type="time" class="form-control" v-model="edit_suat_chieu.gio_ket_thuc" />
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Giá Vé</label>
                            <input type="number" class="form-control" v-model="edit_suat_chieu.gia_ve" />
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Tình Trạng</label>
...
export default {
    ...
    methods: {
        ...
        layDataPhong() {
            axios
                .get('http://127.0.0.1:8000/api/admin/phong/get-data')
                .then(response => {
